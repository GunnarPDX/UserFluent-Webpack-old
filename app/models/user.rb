class User < ApplicationRecord
  ...
  def avatar_small
    if avatar.nil? || avatar.blank?
      'https://res.cloudinary.com/dmqtrnawm/image/upload/w_30,h_30,c_fill/No-Avatar.jpg'
    else
  ...
  def avatar_medium
    if avatar.nil? || avatar.blank?
      'https://res.cloudinary.com/dmqtrnawm/image/upload/w_60,h_60,c_fill/No-Avatar.jpg'
    else
  ...
  def avatar_large
    if avatar.nil? || avatar.blank?
      'https://res.cloudinary.com/dmqtrnawm/image/upload/w_100,h_100,c_fill/No-Avatar.jpg'
    else
